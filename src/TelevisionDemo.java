...
public class TelevisionDemo
{
   public static void main(String[] args)
   {
      ...
      portable.power(); // turns power on
      //Display state of the television
     ...
     //change channel of station
      portable.setChannel(station);
      //Decrease volume of the television
      portable.decreaseVolume();
      portable.decreaseVolume();

      //Display current state of the television
      System.out.println("Channel: " +
                         portable.getChannel()+
                         " Volume: " +
                         portable.getVolume());
